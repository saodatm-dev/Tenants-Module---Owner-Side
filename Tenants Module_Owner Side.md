...
| 6 | **History** | A timeline of all recorded activity for this tenant: status changes, contract renewals, payment events, notes added, documents uploaded. Each entry shows the date, event type, and a brief description. This tab cannot be edited — it is a system-generated audit trail. |
