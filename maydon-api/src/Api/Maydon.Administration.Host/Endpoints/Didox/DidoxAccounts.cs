...
internal sealed record UpdateDidoxAccountRequest(string? Login = null, string? Password = null);

internal sealed class DidoxAccounts : IEndpoint
{
    string IEndpoint.GroupName => DidoxAccountPermissions.GroupName;
    ...
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            .HasPermission(DidoxAccountPermissions.PermissionDidoxAccountList.PermissionName)
            .WithName("Admin_GetDidoxAccounts")
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            .HasPermission(DidoxAccountPermissions.PermissionDidoxAccountGetById.PermissionName)
            .WithName("Admin_GetDidoxAccountById")
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            .HasPermission(DidoxAccountPermissions.PermissionDidoxAccountCreate.PermissionName)
            .WithName("Admin_CreateDidoxAccount")
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            .HasPermission(DidoxAccountPermissions.PermissionDidoxAccountUpdate.PermissionName)
            .WithName("Admin_UpdateDidoxAccount")
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            .HasPermission(DidoxAccountPermissions.PermissionDidoxAccountDelete.PermissionName)
            .WithName("Admin_DeleteDidoxAccount")
