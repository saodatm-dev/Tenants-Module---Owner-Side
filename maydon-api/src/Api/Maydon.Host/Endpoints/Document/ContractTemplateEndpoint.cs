...
internal sealed class ContractTemplateEndpoint : IEndpoint
{
    string IEndpoint.GroupName => "documents";
    string IEndpoint.Route => "contract-templates";
    ...
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
            ...
            CancellationToken ct) =>
        {
            ...
            .WithName("GetContractTemplates_V2")
        ...
        app.MapGet("/{id:guid}", async (
            ...
            CancellationToken ct) =>
        {
            var result = await handler.Handle(new GetContractTemplateByIdQuery(id), ct);
            return result.Match(Results.Ok, CustomResults.Problem);
        })
            ...
            CancellationToken ct) =>
        {
            ...
            .WithName("UpdateContractTemplateBody")
        ...
        app.MapDelete("/{id:guid}", async (
            ...
            CancellationToken ct) =>
        {
            var result = await handler.Handle(new DeleteContractTemplateCommand(id), ct);
            return result.Match(
                () => Results.NoContent(),
                CustomResults.Problem);
        })
            ...
            CancellationToken ct) =>
        {
            ...
            .WithName("PreviewContractTemplatePdf")
        ...
        app.MapGet("/placeholders", async (
            ...
            CancellationToken ct) =>
        {
            var result = await handler.Handle(new GetPlaceholderCatalogQuery(), ct);
            return result.Match(Results.Ok, CustomResults.Problem);
        })
            .WithName("GetPlaceholderCatalog")
