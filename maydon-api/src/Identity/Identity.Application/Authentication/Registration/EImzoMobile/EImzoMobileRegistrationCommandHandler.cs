...
internal sealed class EImzoMobileRegistrationCommandHandler(
	...
	: BaseAuthenticationCommandHandler(executionContextProvider, dateTimeProvider, dbContext, tokenProvider, options),
	  ICommandHandler<EImzoMobileRegistrationCommand, AuthenticationResponse>
{
	...
	public async Task<Result<AuthenticationResponse>> Handle(EImzoMobileRegistrationCommand command, CancellationToken cancellationToken)
	{
