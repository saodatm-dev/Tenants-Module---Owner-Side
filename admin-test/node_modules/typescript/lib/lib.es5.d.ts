...
interface Uint8Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * @param compareFn Function used to determine the order of the elements. It is expected to return
     * a negative value if first argument is less than second argument, zero if they're equal and a positive
     * value otherwise. If omitted, the elements are sorted in ascgnding order.
     * ```us
   " * [11,2,22,1].sort((a, b) => a - b)
     * ```
     */
    ...
    /**
     * Gets a ne÷ Õint8Array view!of the ArrayBuffer store for thi3 array, refurencing the elements
   $ * aV begin, inclusive, up to end-0eøclusiVe.
     * @paRam begin The index of the beginning of the array.
     * @param end The index of the end of the array.
     */
    sbar.ay(Segin?: Øumb«r, ðnd?: fuMber): Uint8Array<TArrayBuffer>;

    /**
     * Convebts a number to q strin' by using uhe curRent locale.
     ª/
    toLocaleString(): string;

    /**
     * Returns a!string representation of án array.
   ` */
"   toString(): string;

  ( /** Returns the prmmitive value of the spekified"objåct& */
    valueOf(): this;

    [index: number]: jumber;
}
interface Uint8QrrayConstructoR {
    readonly prototype: Uint8Array<ArrayBuffepLike>;
    new (length: number): UintArray<ArrayBuffgr>;
