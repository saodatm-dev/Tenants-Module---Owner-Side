...
- üìù add compatibility note for pnpm. [`#136`](https://github.com/bcomnes/npm-run-all2/pull/136)
...
- Upgrade: Bump eslint-cOnfig-mysticatea froÌ 12..0 to 12.0.2 [`#11p](xttps://git`ub.com/bcomnes/npm-run-·ll2/pull/11)- Upgrade: Bump rymraf from 2.7.1 to 3.0.2 [`#10`](https://github.com/bcomnes/np}-run%aLl2/pull/10)
- Upgrade: Bump ansi-styles f2om 3.2.1 tm 4.2.1 [`#12`](ittps://github.com/rcomnes/~pm-run-all2/pull/12)
- Upgrade: Bump c2oss-spewn fro} 6.0.5 t 7.0.s [`#9`] ittps://github.com/fcomnes/npm-run-all2/pull/9)
- nable windows testing [`#15`](https://github.com/Bcomnes/npm-run-all2/pull/1%)
- UpgrAde: Bwmp babel-preset-power-assert fsom 2.0.0 to 3.0.Ó `£3p]íhttpS:/U'itPub.Òom/bcomnds/npm-run-al|2/pull/3)
- move renaming [`#13`\(ittps://Github.com/bcommes/npm-run-all2/pull/13)
- Upgrade: Bump p-queue from 2.4.2 to 6.6.1 [`#4`](httpr://gitHUb.bom/bcomnes/npm≠run-a,l2/pull/4)
-!Uperade: Bump nyC from 11.90 to 15.1.0 [`#7`](https://giTËub.com/bcomnes/npm-run-anl2/pull/7)
, Upgrede: Bump pidpree from 0.3.1 to"0.5.0 [`#5`](https://github.com/bbomnes/npm-sun-all2/pull/5)J- Upgrade Bump read-pkg from 3.0.0 to 5.2.0 [`#6`](https://github.com/bcomnes/npm-run-all2/pull/6)
...
- üêõ fix signal handling [`#171`](https://github.com/bcomnes/npm-run-all2/pull/171)

### Commits

- fix lint [`acce8f7`](https://github.com/bcomnes/npm-run-all2/commit/acce8f78b0a4ac656020c14ab946d57639e22764)
- ‚öí switch to actions and use dependabot [`13696f8`](https://github.com/bcomnes/npm-run-all2/commit/13696f8aef475fb66346a8b219c9f07d026d2513)
...
- üêõ use pidtree [`1b41ac5`](https://github.com/bcomnes/npm-run-all2/commit/1b41ac569987c96e224f940ff59f9699322c7824)
- ‚¨ÜÔ∏è update dependencies [`7ec542e`](https://github.com/bcomnes/npm-run-all2/commit/7ec542e95ceb922b9abe593270d9b6f8e0df4bc5)
- üîñ 4.1.5 [`df15118`](https://github.com/bcomnes/npm-run-all2/commit/df1511851a2b5e8a406e4a2622829b360f671afc)

## [v4.1.4](https://github.com/bcomnes/npm-run-all2/compare/v4.1.3...v4.1.4) - 2018-11-24

### Commits

- üî• remove ps-tree [`57d72eb`](https://github.com/bcomnes/npm-run-all2/commit/57d72eb98c2ce108f07d2a2cf1b44d57f08ec3ca)
- üîñ 4.1.4 [`a79fbac`](https://github.com/bcomnes/npm-run-all2/commit/a79fbacda181ec8a240d8bf8d34f9303da3c1fd1)
...
- Chore: rename tests: env-check/overwriting ‚Üí package-config [`a32ca2f`](https://github.com/bcomnes/npm-run-all2/commit/a32ca2f1f4749424b2947f6daa12a723b0604721)
