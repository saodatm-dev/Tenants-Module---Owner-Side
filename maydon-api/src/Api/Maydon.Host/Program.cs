...
// TODO Only for testing purpose remove it in production !!!
builder.Services.Configure<MyIdOptions>(
	builder.Configuration.GetSection("MyId"));
...
builder.Services
	...
	.AddPdfRendering(builder.Configuration.GetValue<string>("Gotenberg:BaseUrl") ?? throw new InvalidOperationException());
