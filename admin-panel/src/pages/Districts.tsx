...
import { districtsService } from '../services/api'
...
export default function Districts() {
  ...
  const {
    ...
    isUpdating,
    isDeleting,
  } = useCrudQuery<District>('districts', districtsService, pagination)

  const columns = [
    { key: 'name', header: t('name') },
    { key: 'regionName', header: t('regions') },
    { key: 'order', header: t('order') },
  ]

  const renderForm = (
    formData: Partial<District> | null,
